...
public class SHA1
{
    ...
    private void encrypt()
    {
        ...
        for (int j = 0; j <= 19; j++)
        {
            int tmp = this.f4(tmpabcde[0], 5) + this.f1(tmpabcde[1], tmpabcde[2], tmpabcde[3]) + tmpabcde[4] + this.tmpData[j] + 0x5a827999;
        ...
        for (int k = 20; k <= 39; k++)
        {
            int tmp = this.f4(tmpabcde[0], 5) + this.f2(tmpabcde[1], tmpabcde[2], tmpabcde[3]) + tmpabcde[4] + this.tmpData[k] + 0x6ed9eba1;
            tmpabcde[4] = tmpabcde[3];
            tmpabcde[3] = tmpabcde[2];
            tmpabcde[2] = this.f4(tmpabcde[1], 30);
            tmpabcde[1] = tmpabcde[0];
        ...
        for (int l = 40; l <= 59; l++)
        {
            int tmp = this.f4(tmpabcde[0], 5) + this.f3(tmpabcde[1], tmpabcde[2], tmpabcde[3]) + tmpabcde[4] + this.tmpData[l] + 0x8f1bbcdc;
            tmpabcde[4] = tmpabcde[3];
            tmpabcde[3] = tmpabcde[2];
            tmpabcde[2] = this.f4(tmpabcde[1], 30);
            tmpabcde[1] = tmpabcde[0];
        ...
        for (int m = 60; m <= 79; m++)
        {
            int tmp = this.f4(tmpabcde[0], 5) + this.f2(tmpabcde[1], tmpabcde[2], tmpabcde[3]) + tmpabcde[4] + this.tmpData[m] + 0xca62c1d6;
            tmpabcde[4] = tmpabcde[3];
            tmpabcde[3] = tmpabcde[2];
            tmpabcde[2] = this.f4(tmpabcde[1], 30);
            tmpabcde[1] = tmpabcde[0];
    ...
    {
        String param = "aid=001&input_charset=UTF-8&t=1436858709132&uid=123456&uuid=042B214D7A3341B3F351CBCC9730A8A3&key=123456";
